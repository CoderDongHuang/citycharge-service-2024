...
CREATE TABLE IF NOT EXISTS user (
    ...
    notifications TINYINT(1) DEFAULT 1 COMMENT '通知开关（1:开启 0:关闭）',
    dark_mode TINYINT(1) DEFAULT 0 COMMENT '深色模式（1:开启 0:关闭）',
...
CREATE TABLE IF NOT EXISTS contact_message (
    ...
    status ENUM('pending', 'processing', 'replied', 'closed') DEFAULT 'pending' COMMENT '状态',
